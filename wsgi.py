...
תפקיד הקובץ:
    ...
    בייצור (Render) — שירותים שונים רצים על מכונות נפרדות ולא חולקים
    רשת פנימית, לכן wsgi.py מפעיל את שרת האימות ב-thread ברקע
    באותו תהליך כדי שהתקשורת ב-127.0.0.1:5050 תעבוד.
